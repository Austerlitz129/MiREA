...
The [`demo`](demo/) directory contains small authentic input examples, expected column structures, and a short running guide. The records were extracted from the released MiREA disease tables and the CellMarker reference used in the study; no biological examples were fabricated.
